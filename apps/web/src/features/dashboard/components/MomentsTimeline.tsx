  ...
  return (
    <section className="mb-12">
      ...
      <div className="mt-5 flex justify-center">
        <div className="w-full max-w-3xl rounded-[28px] border border-border bg-surface p-2 shadow-sm">
              ...
              {(["timeline", "chapters"] as ViewMode[]).map((mode) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "relative flex-1 min-w-[140px] overflow-hidden rounded-full px-4 py-2 text-sm font-semibold transition-colors duration-300",
                      isActive

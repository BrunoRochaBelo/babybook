...
export function AffiliateLayout() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-indigo-50/50 via-background to-background dark:from-indigo-900/20 dark:via-background dark:to-background text-ink font-sans pb-24 md:pb-0">
      <div className="mx-auto flex flex-col md:flex-row min-h-screen w-full max-w-7xl relative">
        ...
        <aside className="hidden md:flex w-[280px] p-6 sticky top-0 h-screen flex-col transform transition-transform duration-500">
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-[2.5rem] border border-white/50 dark:border-gray-700/50 p-6 shadow-xl shadow-indigo-500/5 flex flex-col h-full overflow-hidden animate-in fade-in slide-in-from-left-4 duration-700">
            <Link to="/affiliate" className="block mb-10 group">
              <div className="text-[10px] font-bold uppercase tracking-[0.2em] text-accent mb-1 opacity-70 group-hover:opacity-100 transition-opacity">
                Baby Book
              </div>
            ...
            <nav className="space-y-2 flex-1">
              <NavLink to="/affiliate" end className={navLinkClass}>
                <LayoutDashboard className="h-4 w-4" /> Dashboard
              </NavLink>
              <NavLink to="/affiliate/settings" className={navLinkClass}>

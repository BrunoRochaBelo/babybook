...
const paginatedResponse = (schema) => z.object({
    items: z.array(schema),
    next: z.string().nullable(),
});
export const paginatedChildrenSchema = paginatedResponse(rawChildSchema).transform(({ items, next }) => ({
...
export const paginatedMomentsSchema = paginatedResponse(rawMomentSchema).transform(({ items, next }) => ({
...
export const paginatedGuestbookSchema = paginatedResponse(rawGuestbookEntrySchema).transform(({ items, next }) => ({

    ...
    <div id="checkout-modal" class="checkout-modal fixed inset-0 z-[9999] hidden" role="dialog" aria-modal="true" aria-labelledby="checkout-title">
      ...
      <div class="checkout-container fixed inset-0 flex items-center justify-center p-4 pointer-events-none">
        <div class="checkout-panel bg-white rounded-3xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-hidden pointer-events-auto transform transition-all duration-300 scale-95 opacity-0">
          ...
          <!-- Content -->
          <div class="checkout-content p-4 pb-5 overflow-y-auto" style="max-height: calc(90vh - 140px);">
            ...
            <div class="checkout-mode-select" data-checkout-view="select">
              <div class="space-y-3">
                ...
                <button 
                  type="button"
                  class="checkout-option group w-full p-4 rounded-2xl border-2 border-gray-200 hover:border-indigo-500 hover:bg-indigo-50/50 transition-all text-left"
                ...
                <button 
                  type="button"
                  class="checkout-option group w-full p-4 rounded-2xl border-2 border-gray-200 hover:border-emerald-500 hover:bg-emerald-50/50 transition-all text-left"
                ...
                <button 
                  type="button"
                  class="checkout-option group w-full p-4 rounded-2xl border-2 border-gray-200 hover:border-rose-500 hover:bg-rose-50/50 transition-all text-left"
              ...
              <div class="mt-8 pt-6 border-t border-gray-100">
                ...
                <div class="mt-4 pt-4 border-t border-gray-100 text-center">
                  <a href="/pro.html" class="inline-flex items-center gap-1.5 text-xs text-pink-600 hover:text-pink-700 transition-colors">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"/>
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z"/>
                    </svg>
                    É fotógrafo? Seja nosso parceiro →
                  </a>
                </div>
              </div>
            </div>
